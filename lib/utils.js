...
function getSlugHashMap() {
    ...
    slugMap["/"] = Node.getMarkdownFolder() + "/🌳 GRAPH.canvas";
...
export function constructGraphData() {
    ...
    if (Node.isFile(filepath)) {
        ...
        console.log("constructing graph-data");
...
export function getDirectoryData() {
    const filteredDirectory = dirTree(Node.getMarkdownFolder(), {extensions: /\.(md|canvas)/});
